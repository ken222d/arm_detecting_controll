...
class ArmControll(Node):
    ...
    def step_attach(self):
        ...
        # コールバックで処理を継続
            ...
            # アタッチ完了後に次のステップへ
                self.timer = self.create_timer(self.wait_duration, self.step_color_pose)
    ...
    def step_color_pose(self):
        self.timer.cancel()
        self.get_logger().info(f"Step 3: Move to pose for {self.latest_color}")
